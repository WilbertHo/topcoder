...
You are given the parameters used in these restrictions: an integer K and two tuple (integer)s x and t.
...
Method:maxHeight
Parameters:integer, integer, tuple (integer), tuple (integer)
Returns:long integer
Method signature:def maxHeight(self, N, K, x, t):
