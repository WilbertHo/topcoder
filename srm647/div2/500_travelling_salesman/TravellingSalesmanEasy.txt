...
You are given information about those items in tuple (integer)s profit and city.
...
These are given in the tuple (integer) visit.
...
Method:getMaxProfit
Parameters:integer, tuple (integer), tuple (integer), tuple (integer)
Returns:integer
Method signature:def getMaxProfit(self, M, profit, city, visit):
