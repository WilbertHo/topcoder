...
You are given these choices as a tuple (integer) position and a string value.
...
Method:getNumber
Parameters:integer, tuple (integer), string
Returns:integer
Method signature:def getNumber(self, N, position, value):
